...
const CRITERIA_OPTIONS = {
	...
	[CRITERIA_TYPES.RARITY]: { label: 'Rarity', values: ['Common', 'Uncommon', 'Rare', 'Special', 'Event', 'Novelty', 'Legendary'] },
...
function matchesCriterion(pokemon, criterion) {
	...
	switch (criterion.type) {
		...
		case CRITERIA_TYPES.RARITY:
			const rarityMap = { 'Common': 'common', 'Uncommon': 'uncommon', 'Rare': 'rare', 'Special': 'special', 'Event': 'event', 'Novelty': 'novelty', 'Legendary': 'legendary' };
